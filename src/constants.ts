...
export const CONTENT = {
  ...
  slideDiscovery: {
    ...
    examplesLabel: "على سبيل المثال",
    goalButtonLabel: "الهدف من السؤال",
    goalButtonHideLabel: "إخفاء الهدف",
    goalHeading: "الهدف الحقيقي",
    questions: [
      {
        number: "السؤال الأول",
        ...
        examples: [
          ...
          "تحسين الربحية",
          "إعادة تنظيم وتشغيل",
          "التوسع بالخدمات أو المناطق",
          "الاستعداد لمرحلة مؤسسية أكبر"
        ],
        goalIntro: "فهم:",
        goalItems: [
          "mindset الإدارة",
      ...
      },
      {
        ...
        examples: [
          "تعدد الفروع والخدمات",
          "وضوح التقارير والرؤية التنفيذية",
          "سرعة اتخاذ القرار",
          "التنسيق بين الإدارات",
          "الاستفادة من الأصول والإمكانيات",
          "الحفاظ على نفس جودة التشغيل مع التوسع"
        ],
        goalIntro: "كشف:",
        goalItems: [
      ...
      },
      {
        ...
        examples: [
          "نشعر أن الإمكانيات الحالية أكبر من النتائج",
          "هناك فرص غير مستغلة داخل التشغيل الحالي",
          "التوسع الحالي لم ينعكس بالكامل على النتائج",
          "بعض القدرات أو الأصول لا يتم الاستفادة منها بالشكل الأمثل",
          "يوجد إمكانية لتحقيق نتائج أعلى بنفس الموارد الحالية"
        ],
        goalIntro: "فتح باب:",
        goalItems: ["Value Gap", "Hidden Opportunities", "Recoverable Value"],
        goalNote: "بطريقة ذكية وغير هجومية."
      },
      {
        number: "السؤال الرابع",
        question: "أين ترون أكبر فرصة للتحسين اليوم؟",
        examples: [
          "رفع كفاءة الاستفادة من الإمكانيات الحالية",
          "تحسين الربحية دون توسعات كبيرة إضافية",
          "تسريع النمو بطريقة أكثر استدامة",
          "تحسين وضوح الرؤية التنفيذية وسرعة القرار",
          "تقليل التسرب التشغيلي أو التجاري",
          "تحسين التنسيق بين الإدارات والخدمات",
          "رفع كفاءة الأداء بين الفروع أو الوحدات التشغيلية",
          "تحويل الفرص الحالية إلى نتائج قابلة للقياس"
        ],
        goalIntro: "تحديد:",
        goalItems: [
          "أين يبدأ الـ Deep Dive",
          "أين توجد الأولوية الأعلى تأثيرًا",
          "هل الحديث سيكون: optimization · profitability · governance · execution · scalability · visibility"
        ]
      }
    ]
  },
